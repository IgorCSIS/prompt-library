...
export const metadata: Metadata = {
  ...
  description:
    'The principles behind the MASTER prompt library: every prompt earns its place by being distinct, every Full MASTER prompt has all 9 layers, the personal voice is the point.',
  keywords: [
    ...
    <>
      <section className="container-page pt-16 pb-12">
        <div className="max-w-prose">
          ...
          <h1 className="heading-display mb-8">Why this library exists.</h1>

          <div className="prose prose-invert max-w-none space-y-6 text-fg-muted leading-relaxed">
            <p className="text-lg">
              This started as a prompt log, the working notebook a prompt
              engineer keeps to track and improve their craft. It grew into
              something I actually use: a working library of{' '}
              {STATS.totalPrompts} prompts I reach for in real work.
            </p>
            ...
            <Principle
              ...
              body="In Part II, every template has [BRACKETED_VARIABLES] for the user to fill in. That is not laziness, it is design. A template that pre-fills the variables is a one-shot prompt, not a template."
            />
            ...
            <p>Three parts, each with a different purpose:</p>
            ...
            <p>
              ...
              re-test the most-used templates, run the constraint audit on the
              one that drifted most, retire any template I haven't used in 90
              days. The library is durable; individual prompts are not.
            </p>

            <h2 className="text-2xl font-bold text-fg mt-12 mb-4">Stack</h2>

            <p>
              Static Next.js site with Tailwind, deployed via GitHub Pages or
              Vercel. Search is client-side via Fuse.js, no analytics, no
              tracking, no third-party fonts beyond Google's Inter and JetBrains
              Mono. The whole site is under 500 KB.
            </p>
          </div>
...
function PartCard({
  ...
  return (
    <Link
      href={href}
      className="card p-4 group hover:border-accent/30 transition-all"
    >
